...
unetSS = genUnet(root_folder=code_dir, 
    image_folder = 'resized_image_test_data',
    mask_folder = 'resized_mask_test_data',
    ...
    bs = 1, 
    nb_classes=2,
    img_row=1024,img_col=800,channel=3,
    classifier = 'softmax',
    optimizer =optimizer,
    lr=lr,
    decay=decay,
...
if __name__ == '__main__':
    if predict:
        ...
        weightFile=(os.path.join(unetSS.weight_folder,'/home/m164064/Amyloid_US/results_folder/unet_CT_SS_2019122_135241/100_unet_CT_SS_2019122_135241.h5'))
