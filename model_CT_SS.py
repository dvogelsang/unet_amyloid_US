...
class Unet_CT_SS(object):
    ...
    def loadTrainingData(self,images_path,labels_path, each):
        ...
        [self.img_rows,self.img_cols,self.numImgs,self.channel] = images.shape
        
        images = images.transpose(2,0,1,3).astype(self.dtype)
        labels = labels.transpose(2,0,1).astype(self.dtypeL)
